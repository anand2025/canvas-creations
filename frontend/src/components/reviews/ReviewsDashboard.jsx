  ...
  return (
    <div className="space-y-10 py-6 animate-in fade-in duration-500">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
           <h1 className="text-4xl font-black text-foreground uppercase tracking-tighter">{title}</h1>
           <p className="text-foreground/50 font-bold uppercase tracking-widest text-xs">{subtitle}</p>
        </div>
      </div>
